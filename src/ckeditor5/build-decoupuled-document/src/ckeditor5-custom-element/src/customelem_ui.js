...
export default class CustomElemUI extends Plugin {
	...
	init() {
		...
		for (let i = 0; i < items.length; i++) {
			...
			const onCreate = this._safeGet(items[i].onCreate, () => { });
			...
			editor.commands.add(com, new CustomElemCommand(editor, tag, text, inline, attr, onCreate));
